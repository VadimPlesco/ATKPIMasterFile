		...
		scrollTo: function (scrollTo, options) {
			...
			function callbacks(cb){
				this.mcs={
				    ...
				    draggerBottom: parseInt(mCSB_container.css("height"))+parseInt(mCSB_container.css("top"))-parseInt(mCustomScrollBox.css("height")),
				...
				this.mcs_box = {
				    height: mCSB_container.outerHeight()
				};
				switch(cb){
