...
using ATKPIMasterFile.Web.Models;
...
namespace ATKPIMasterFile.Web.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var user = _userAggregateRoot.GetUser(model.Email, model.Password);

            if (user != null)
            {
                FormsAuthentication.SetAuthCookie(user.UserId.ToString(), false);
                return RedirectToRoute("Default", new { controller = "User", action = "Details" });//RedirectToLocal(returnUrl);
            }
