...
namespace ATKPIMasterFile.Web
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/kinkyApp.js")
              .Include("~/Scripts/KinkyApp/SmileLinkFormatter.js")
              .Include("~/Scripts/KinkyApp/jquery.sm-unobtrusive-ajax.js")
              //.Include("~/Scripts/jquery.unobtrusive-ajax.js")
              .Include("~/Scripts/KinkyApp/modal-window.js")
              .Include("~/Scripts/KinkyApp/popUp.js")
              .Include("~/Scripts/KinkyApp/helpers.js")
              .Include("~/Scripts/KinkyApp/interest-buttons.js")
              .Include("~/Scripts/KinkyApp/feed_grid.js")
              .Include("~/Scripts/KinkyApp/feed.js")
              .Include("~/Scripts/KinkyApp/typeahead.js")
              .Include("~/Scripts/KinkyApp/summernote.js")
              .Include("~/Scripts/KinkyApp/analytics.js")
             );

            bundles.Add(new ScriptBundle("~/bundles/additional.js")
                  .Include("~/Scripts/KinkyApp/broadcasting.publish.js")
                  .Include("~/Scripts/KinkyApp/broadcasting.watch.js")
                  .Include("~/Scripts/KinkyApp/viewModel.notificationsViewModel.js")
                  .Include("~/Scripts/KinkyApp/viewModel.chatViewModel.js")
                  .Include("~/Scripts/KinkyApp/viewModel.js")
